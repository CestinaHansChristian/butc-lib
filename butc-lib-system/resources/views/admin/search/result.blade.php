    ...
    <div class="main-wrapper relative h-screen">
        <div class="py-5 relative">
            <form action="{{ route('admin.search') }}" method="get" class="flex mx-2">
                <div class="bg-sky-700 w-xl lg:w-4xl flex mx-auto overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="p-3 w-full flex justify-between">
                        <div class="search-btn-wrapper w-full xl:mx-5">
                            <input autocomplete="off" required type="text" name="q" class="bg-slate-50 w-full rounded-lg p-2 placeholder:text-xl" placeholder="Enter a book title . . .">
                        </div>
                    </div>
