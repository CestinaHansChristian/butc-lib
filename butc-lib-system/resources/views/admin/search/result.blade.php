<x-app-layout>
    <div class="main-wrapper relative h-screen">
        <div class="py-5 relative">
            ...
            <div class="wrapper absolute top-28 border-2 border-black container">
                <div class="wrapper overflow-y-scroll h-64 max-w-7xl border-2 border-black">
                    @foreach ($adminSearchResult as $r)
